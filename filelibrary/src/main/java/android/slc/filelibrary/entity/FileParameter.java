...
import android.slc.filelibrary.filter.CompositeFilter;
import android.slc.filelibrary.filter.HiddenFilter;
import android.slc.filelibrary.filter.PatternFilter;
