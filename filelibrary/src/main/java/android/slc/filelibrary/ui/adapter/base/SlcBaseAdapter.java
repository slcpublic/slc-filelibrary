package android.slc.filelibrary.ui.adapter.base;
 ...
 * author：on the way
 */
public abstract class SlcBaseAdapter<T extends SlcBaseAdapter.ItemEntity> extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public SlcBaseAdapter(@NonNull Context context, @NonNull List<T> date) {
    ...
    public SlcBaseAdapter(@NonNull Context context, @NonNull List<T> date, @LayoutRes int layoutId) {
        this(context, date);
    ...
    public BaseViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        ...
        switch (viewType) {
            ...
            case FOOTER_VIEW:
                ...
                break;
            default:
                baseViewHolder = new BaseViewHolder(mLayoutInflater.inflate(mLayoutArray.get(viewType), viewGroup, false));
    ...
    protected BaseViewHolder createBaseViewHolder(View view) {
        ...
        if (z == null) {
            ...
            baseViewHolder = createGenericKInstance(z, view);
        }
    ...
    public void onBindViewHolder(@NonNull BaseViewHolder baseViewHolder, int position) {
        ...
        switch (viewType) {
            ...
            case 0:
            default:
                convert(baseViewHolder, getItem(position - getHeaderLayoutCount()));
                break;
        }
    }
    @Nullable
    ...
    public interface OnItemChildClickListener {
         ...
         */
        void onItemChildClick(SlcBaseAdapter adapter, View view, int position);
    }
    ...
    public interface OnItemChildLongClickListener {
         ...
         */
        boolean onItemChildLongClick(SlcBaseAdapter adapter, View view, int position);
    }
    ...
    public interface OnItemLongClickListener {
         ...
         * @return true if the callback consumed the long click ,false otherwise
         */
        boolean onItemLongClick(SlcBaseAdapter adapter, View view, int position);
    }
    ...
    public interface OnItemClickListener {
         ...
         */
        void onItemClick(SlcBaseAdapter adapter, View view, int position);
    }
