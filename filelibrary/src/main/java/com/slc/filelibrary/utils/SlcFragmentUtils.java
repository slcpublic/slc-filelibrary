package com.slc.filelibrary.utils;
 ...
 * author: on the way
 */
public final class SlcFragmentUtils {
     ...
     * @param add            The fragment will be add.
     * @param containerId    The id of container.
     * @param sharedElements A View in cpb_complete_state_selector disappearing Fragment to match with
     *                       cpb_complete_state_selector View in an
     *                       appearing Fragment.
     */
    public static void add(@NonNull final FragmentManager fm,
                           @NonNull final Fragment add,
    ...
    private static void operate(final int type,
        ...
        if (src != null && src.isRemoving()) {
            Log.e("SlcFragmentUtils", src.getClass().getName() + " is isRemoving");
            return;
        }
        String name;
        Bundle args;
